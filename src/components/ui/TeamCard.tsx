...
const TeamCard = () => {
  return (
    <>
      <section className="bg-natural-white  rounded-lg z-50 absolute bottom-12 right-0 flex flex-col items-center justify-center gap-1 px-2 py-2 shadow-lg">
        ...
        <div className="flex relative left-4">
            ...
            <p className="bg-natural-grey text-center flex items-center justify-center w-10 rounded-full relative right-7 z-50">3+</p>
        </div>
      </section>
    </>
  );
